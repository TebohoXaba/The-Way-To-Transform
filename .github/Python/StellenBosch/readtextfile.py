...
with open('.\Task 10\Examples\example.txt', 'r') as file:
...
with open('.\Task 10\Examples\example.txt', 'r', encoding='utf-8') as file:
    lines = file.readlines() 
...
with open('.\Task 10\Examples\example.txt', 'r', encoding='utf-8-sig') as file:
    lines = file.readlines() 
print(lines)
